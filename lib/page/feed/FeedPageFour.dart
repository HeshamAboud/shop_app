...
import 'package:nice_ui/util/SizeUtil.dart';
  ...
  Widget descriptionText() => Container(
    ...
    child: RichText(
      text: TextSpan(
          ...
          children: <TextSpan>[
            TextSpan(
                text: cardConsts[0]['action'].toString(),
  ...
  Widget _socialActionRow() {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          _socialAction(favIcon, cardConsts[0]['like'].toString()),
          _socialAction(chatIcon, cardConsts[0]['chat'].toString()),
          _socialAction(shareIcon, cardConsts[0]['share'].toString())
        ],
      ),
    );
  }
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
                image: AssetImage(cardConsts[0]['avatar_image'].toString())),
            boxShadow: SHADOW,
          ),
        ));
  }
